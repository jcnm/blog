...
- OpenAI a lancé une [nouvelle version de **Codex** le 16 mai 2025](https://www.itpro.com/software/development/openai-just-launched-codex-a-new-ai-agent-for-software-engineering), en tant qu’agent de développement cloud intégré à ChatGPT. Ce Codex est un **agent logiciel d’ingénierie (SWE)** basé sur le modèle o3, capable d’[exécuter plusieurs tâches en parallèle](https://venturebeat.com/programming-development/openai-launches-research-preview-of-codex-ai-software-engineering-agent-for-developers-with-parallel-tasking/) (écriture de code, débogage, tests). Il est en phase de “research preview” pour les utilisateurs Pro, Enterprise, et Team de ChatGPT.
- [OpenAI a acquis **Windsurf**](https://www.nytimes.com/2025/05/13/technology/openai-windsurf-talks.html) (anciennement Codeium) pour environ 3 milliards de dollars, une [plateforme d’assistance au codage IA](https://venturebeat.com/ai/report-openai-is-buying-ai-powered-developer-platform-windsurf-what-happens-to-its-support-for-rival-llms/) similaire à **Cursor**, avec 800 000 utilisateurs développeurs et 1 000 entreprises clientes. Windsurf est connu pour son approche de “vibe coding”, permettant d’écrire et d’éditer du code via des conversations avec un chatbot IA.
- Windsurf utilisait des modèles d’IA d’OpenAI, Anthropic, et Google, mais a récemment lancé [ses propres modèles SWE-1](https://techcrunch.com/2025/05/15/vibe-coding-startup-windsurf-launches-in-house-ai-models/), renforçant son indépendance technologique.
1. **Concurrence dans le marché des outils de codage IA** :
- Le marché des assistants de codage IA est en pleine expansion, avec des acteurs comme **Cursor** (valorisé à 9 milliards de dollars), **GitHub Copilot**, **Amazon CodeWhisperer**, **Google Gemini Code Assist**, et **Anthropic** (via Claude).
